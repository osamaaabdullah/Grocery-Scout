...
from backend.database import get_write_db, get_read_db
...
async def search_price_by_product(product_name: str, category: str = None, db: Session = Depends(get_read_db)):
